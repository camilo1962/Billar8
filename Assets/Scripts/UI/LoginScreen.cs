...
namespace RevolutionGames.UI
{
    public class LoginScreen : MonoBehaviour
    {
        ...
        public void LoginEmailContinueButtonClicked()
        {
            ...
            {
                emailLoginErrorText.text = "Por favor, escribe tu nombre.";
                print("emailLoginErrorText" + emailLoginErrorText);
            }
            else if (playreName.Length <= 2)
            {
                emailLoginErrorText.text = "El nombre debe tener al menos 3 caracteres.";
            }
            else if (playerEmailId.Length == 0)
            {
                emailLoginErrorText.text = "Por favor ingrese su ID de correo electrónico.";
            }
            else if (Regex.IsMatch(playerEmailId, matchEmailPattern) == false)
            {
                emailLoginErrorText.text = "Por favor ingrese una dirección de correo electrónico válida.";
            }
            else
            {
        ...
        public void LoginEmailContinueButtonCallBack(bool oldUser = false)
        {
            ...
            if (!oldUser)
            {
                ...
                emailNewUserNameText.text = "Hola " + GameData.Instance().PlayerName + "!";
        ...
        public void EmailNewUserPasswordContinueButtonClicked()
        {
            ...
            {
                emailPasswordEnterErrorText.text = "Por favor, ingrese contraseña";
            }
            else if (playerPassword.Length < 4 || playerPassword.Length > 12)
            {
                emailPasswordEnterErrorText.text = "Por favor ingrese una contraseña válida";
            }
            else
            {
        ...
        public void EmailOldUserPasswordContinueButtonClicked()
        {
            ...
            if (playerPassword.Length == 0)
            {
                emailPasswordLoginErrorText.text = "Por favor, ingrese contraseña";
            }
            else if (playerPassword.Length < 4 || playerPassword.Length > 12)
            {
                emailPasswordLoginErrorText.text = "Por favor ingrese una contraseña válida";
            }
            else
            {
        ...
        public void EmailForgotPasswordButtonClicked()
        {
            ...
            {
                emailForgotPasswordErrorText.text = "Por favor ingrese su ID de correo electrónico";
            }
            else if (Regex.IsMatch(playerEmailId, matchEmailPattern) == false)
            {
                emailForgotPasswordErrorText.text = "Por favor ingrese una ID de correo electrónico válida";
            }
            else
            {
        ...
        public void GuestLoginContinueButtoinClicked()
        {
            ...
            {
                guestErrorText.text = "Por favor, escriba su nombre";
            }
            else if (playerName.Length < 4 || playerName.Length > 12)
            {
                guestErrorText.text = "Por favor ingresa un nombre válido";
            }
            else
            {
