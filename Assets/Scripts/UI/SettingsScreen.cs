...
namespace RevolutionGames.UI
{
    public class SettingsScreen : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            Debug.Log("Cualquier otra plataforma");
            ...
            chatText.Add("¡Buena suerte!");
            chatText.Add("¡Buen tiro!");
            chatText.Add("¡Bien jugado!");
            chatText.Add("¡Eres Bueno!");
            chatText.Add("¡Gracias!");
        ...
        public void OnEnable()
        {
            if (PlayerPrefs.GetInt("email login") == 0)
            {
                ...
                loginEmailButton.transform.GetChild(0).GetComponent<Text>().text = "Iniciar sesión con correo electrónico";
            }
            else
            {
                ...
                loginEmailButton.transform.GetChild(0).GetComponent<Text>().text = "Conectado";
            }
            ...
            else
            {
                ...
                loginGooglePlayButton.transform.GetChild(0).GetComponent<Text>().text = "Conectado";
            }
            if (PlayerPrefs.GetInt("facebook login") == 0)
            {
                loginFacebookButton.transform.GetComponent<Button>().interactable = true;
                loginFacebookButton.transform.GetChild(0).GetComponent<Text>().text = "Iniciar sesión con Facebook";
            }
            else
            {
                loginFacebookButton.transform.GetComponent<Button>().interactable = false;
                loginFacebookButton.transform.GetChild(0).GetComponent<Text>().text = "Conectado";

            }
            if (PlayerPrefs.GetInt("apple login") == 0)
            {
                loginAppleButton.transform.GetComponent<Button>().interactable = true;
                loginAppleButton.transform.GetChild(0).GetComponent<Text>().text = "Iniciar sesión con Apple";
            }
            else
            {
                loginAppleButton.transform.GetComponent<Button>().interactable = false;
                loginAppleButton.transform.GetChild(0).GetComponent<Text>().text = "Conectado";
            }
