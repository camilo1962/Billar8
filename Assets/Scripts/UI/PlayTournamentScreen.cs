...
namespace RevolutionGames.UI
{
    public class PlayTournamentScreen : MonoBehaviour
    {
        ...
        public void Start()
        {
            quarterFinal1StartingText.text = "Comenzar";
            quarterFinal2StartingText.text = "Esperar";
            quarterFinal3StartingText.text = "Comenzar";
            quarterFinal4StartingText.text = "A partir de.";
