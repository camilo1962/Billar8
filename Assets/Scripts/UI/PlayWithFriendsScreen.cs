...
namespace RevolutionGames.UI
{
    public class PlayWithFriendsScreen : MonoBehaviour
    {
        ...
        public void GenerateFriendsList(int numberOfFriends)
        {
            ...
            friendsChallengeList[0].transform.GetChild(4).GetComponent<Text>().text = "Camilo";
        ...
        public void GenerateFriendsOfFriendsList(int numberOffFriends)
        {
            ...
            friendsOfFriendsChallengeList[0].transform.GetChild(2).GetComponent<Text>().text = "Camilo";
        ...
        public void GeneraateFindFriendsList(int numberOfFriends)
        {
            ...
            findFriendsList[0].transform.GetChild(2).GetComponent<Text>().text = "Camilo";
        ...
        public void OnFriendsActivityButtonCallBack(List<Friend> friends)
        {
            ...
            for (int i = 0; i < friends.Count; i++)
            {
                ...
                friendsData.transform.GetChild(1).GetComponent<Text>().text = friends[i].player_name + "¡Te desafié!";
