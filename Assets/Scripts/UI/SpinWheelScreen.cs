...
namespace RevolutionGames.UI
{
    ...
    public class SpinWheelScreen : MonoBehaviour
    {
        ...
        public void OnStartFreeSpinButtonCallBack()
        {
            ...
            print("columna vertebral" + PlayerPrefs.GetInt("spin wheel show"));
            int spinCount = PlayerPrefs.GetInt("spincount");
            print("llamar de vuelta");
            if (spinCount == 1)
            {
        ...
        public void SpinWheelScreenUpdate()
        {
            ...
            else
            {
                ...
                print("time" + minutes);
                print("time" + seconds);
                freeSpinTimeText.text = "La rueda de Vueltas Gratis se habilitará después \n" + hours + "hrs : " + minutes + "mins : " + seconds + "secs\n" +
                "Pulsa Aceptar para obtener una Vuelta, paga por solo 0,89 $";
