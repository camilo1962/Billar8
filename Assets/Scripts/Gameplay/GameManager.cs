...
namespace RevolutionGames.Game
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        //devuelve verdadero si el balón pasado es del grupo del jugador o si el jugador no tiene ningún grupo asignado
