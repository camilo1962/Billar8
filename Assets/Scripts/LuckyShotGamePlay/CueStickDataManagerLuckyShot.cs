...
namespace RevolutionGames.Data
{
    ...
    class CueStickLuckyShot //APIData
    {
        ...
        private string cueType; // Basic, advanced, Legendario
    ...
    public class CueStickDataManagerLuckyShot : MonoBehaviour
    {
        ...
        private List<int> surpriseLegendarioCueStickList;
        ...
        void Awake()
        {
            ...
            surpriseLegendarioCueStickList = new List<int>();
            ...
            SetCueStickData(cueSprites[4], "Archangel Cue", "Surprise", "NA", "1k", 0, 100, 100, 5, new int[] { 4, 1, 2, 3, 4, 5 }, new int[] { 0, 0, 1, 0, 2, 3 },
                new int[] { 0, 0, 1, 2, 0, 0 }, new int[] { 0, 0, 1, 0, 0, 1 }, new int[] { 0, 0, 0, 1, 2, 3 }, 2, 2, "Legendario", 1, 0, 9, 9, 8, 8, 50);
            ...
            int force, int aim, int spin, int time, int charge)
        {
            ...
            else if (category == "Sorpresa")
            {
                ...
                else if (cueType == "Epico")
                {
                    surpriseEpicCueStickList.Add(surpriseCueStickList.Count - 1);
                }
                else if (cueType == "Legendario")
                {
                    surpriseLegendarioCueStickList.Add(surpriseCueStickList.Count - 1);
                }
                if (isUnlocked == 1)
                {
                    ownedCueStickList.Add(cueStick);
        ...
        public int GetSurpriseLegendarioCueStickIndex()
        {
            return surpriseLegendarioCueStickList[Random.Range(0, surpriseLegendarioCueStickList.Count)];
        }
        ...
        public void StandardCueDetails()
        {
            ...
            CueStick theGunmanCue = new CueStick(cueSprites[1], "La señal del Pistolero", "Estandar", null, "1.8K", 1800, "175", 175, 0, 0, 0, null, null, 0, 0, theGunmanCueStickProperties);
            standardCueStickList.Add(theGunmanCue);
            CueStickProperties standardCueStickProperties = new CueStickProperties(3, 3, 3, 0, 50);
            CueStick standardCue = new CueStick(cueSprites[2], "Taco Estandar", "Estandar", null, "2k", 2000, "200", 200, 0, 0, 0, null, null, 0, 0, standardCueStickProperties);
            standardCueStickList.Add(standardCue);
            CueStickProperties millionarieCueStickProperties = new CueStickProperties(8, 7, 6, 3, 50);
            CueStick millionarieCue = new CueStick(cueSprites[3], "Taco Millonario", "Estandar", null, "1M", 1000000, "100K", 100000, 0, 0, 0, null, null, 0, 0, millionarieCueStickProperties);
            ...
            CueStick multimillionaireCue = new CueStick(cueSprites[4], "Taco Multimillonario", "Estandar", null, "5M", 5000000, "350K", 350000, 0, 0, 0, null, null, 0, 0, multimillionaireCueStickProperties);
            ...
            CueStick billionaireCue = new CueStick(cueSprites[0], "Taco Billonario", "Estandar", null, "1B", 1000000000, "5M", 5000000, 0, 0, 0, null, null, 0, 0, billionaireCueStickProperties);
            standardCueStickList.Add(billionaireCue);
            CueStickProperties billionCueStickProperties = new CueStickProperties(9, 8, 7, 7, 50);
            CueStick billionCue = new CueStick(cueSprites[1], "Taco Billonario", "Estandar", null, "1.5B", 1500000000, "7.5M", 7500000, 0, 0, 0, null, null, 0, 0, billionCueStickProperties);
        ...
        public void VictoryCueDetails()
        {
            ...
            CueStick victoryCue = new CueStick(cueSprites[1], "Taco Victoria", "Victoria", "London", "NA", 0, "0", 0, 0, 4, 5, victoryCueStickLevels, "Basico", 0, 0, victoryCueStickProperties);
            ...
            CueStick pineCue = new CueStick(cueSprites[1], "Taco de pino", "Victoria", "London", "NA", 0, "0", 0, 0, 4, 5, pineCueStickLevels, "Basico", 0, 0, pineCueStickProperties);
            ...
            CueStick cowCue = new CueStick(cueSprites[1], "Taco de vaca", "Victoria", "London", "NA", 0, "0", 0, 0, 4, 5, cowCueStickLevels, "Basico", 0, 0, cowCueStickProperties);
            ...
            CueStick modernCue = new CueStick(cueSprites[1], "Taco Moderno", "Victoria", "Sydney", "NA", 0, "0", 0, 0, 4, 5, modernCueStickLevels, "Basico", 0, 0, modernCueStickProperties);
            ...
            CueStick royalBlueCue = new CueStick(cueSprites[1], "Taco Azul Real", "Victoria", "Tokyo", "NA", 0, "220", 220, 0, 4, 5, royalBlueCueStickLevels, "Basico", 0, 0, royalBlueCueStickProperties);
            ...
            CueStick ashCue = new CueStick(cueSprites[1], "Taco de Ceniza", "Victoria", "Shanghai", "NA", 0, "0", 0, 0, 4, 5, ashCueStickLevels, "Basico", 0, 0, ashCueStickProperties);
            ...
            CueStick crocodileCue = new CueStick(cueSprites[1], "Taco Cocodrilo", "Victoria", "Tokyo", "NA", 0, "300", 300, 0, 4, 5, crocodileCueStickLevels, "Advanzado", 0, 0, crocodileCueStickProperties);
            ...
            CueStick elvenCue = new CueStick(cueSprites[1], "Taco Élfico", "Victoria", "Cairo", "NA", 0, "2.1K", 2100, 0, 4, 5, elvenCueStickLevels, "Advanzado", 0, 0, elvenCueStickProperties);
            ...
            CueStick neonCue = new CueStick(cueSprites[1], "Taco de Neón", "Victoria", "Cairo", "NA", 0, "0", 0, 0, 4, 5, neonCueStickLevels, "Advanzado", 0, 0, neonCueStickProperties);
            ...
            CueStick pharaohCue = new CueStick(cueSprites[1], "Taco Faraón", "Victoria", "Jakarta", "NA", 0, "0", 0, 0, 4, 5, pharaohCueStickLevels, "Advanzado", 0, 0, pharaohCueStickProperties);
            ...
            CueStick rosewoodCue = new CueStick(cueSprites[1], "Taco de Palisandro", "Victoria", "Sydney", "NA", 0, "0", 0, 0, 4, 5, rosewoodCueStickLevels, "Basico", 0, 0, rosewoodCueStickProperties);
            ...
            CueStick traditionalCue = new CueStick(cueSprites[1], "Taco Tradicional", "Victoria", "London", "NA", 0, "0", 0, 0, 4, 5, traditionalCueStickLevels, "Basico", 0, 0, traditionalCueStickProperties);
            ...
            CueStick majesticCue = new CueStick(cueSprites[1], "Taco Majestad", "Victoria", "Shanghai", "NA", 0, "0", 0, 0, 4, 5, majesticCueStickLevels, "Advanzado", 0, 0, majesticCueStickProperties);
            ...
            CueStick antiqueCue = new CueStick(cueSprites[1], "Taco Antiguo", "Victoria", "Sydney", "NA", 0, "0", 0, 0, 4, 5, antiqueCueStickLevels, "Basico", 0, 0, antiqueCueStickProperties);
            ...
            CueStick compositeCue = new CueStick(cueSprites[1], "Taco Composite", "Victoria", "London", "NA", 0, "0", 0, 0, 4, 5, compositeCueStickLevels, "Basico", 0, 0, compositeCueStickProperties);
            ...
            CueStick blackHoleCue = new CueStick(cueSprites[1], "Taco de Agujero Negro", "Victoria", "Mumbai", "NA", 0, "0", 0, 0, 4, 5, blackHoleCueStickLevels, "Experto", 0, 0, blackHoleCueStickProperties);
            ...
            CueStick czarCue = new CueStick(cueSprites[1], "Taco del Zar", "Victoria", "Mumbai", "NA", 0, "0", 0, 0, 4, 5, czarCueStickLevels, "Experto", 0, 0, czarCueStickProperties);
            ...
            CueStick diamondCue = new CueStick(cueSprites[1], "Taco Diamante", "Victoria", "Seoul", "NA", 0, "0", 0, 0, 4, 5, diamondCueStickLevels, "Experto", 0, 0, diamondCueStickProperties);
            ...
            CueStick emeraldCue = new CueStick(cueSprites[1], "Taco Esmeralda", "Victoria", "Mumbai", "NA", 0, "0", 0, 0, 4, 5, emeraldCueStickLevels, "Experto", 0, 0, emeraldCueStickProperties);
            ...
            CueStick frankenCue = new CueStick(cueSprites[1], "Taco Franco", "Victoria", "Rome", "NA", 0, "0", 0, 0, 4, 5, frankenCueStickLevels, "Experto", 0, 0, frankenCueStickProperties);
            ...
            CueStick galaxyCue = new CueStick(cueSprites[1], "Taco Galactico", "Victoria", "Berlin", "NA", 0, "0", 0, 0, 4, 5, galaxyCueStickLevels, "Advanzado", 0, 0, galaxyCueStickProperties);
            ...
            CueStick goldCue = new CueStick(cueSprites[1], "Taco de Oro", "Victoria", "Seoul", "NA", 0, "0", 0, 0, 4, 5, goldCueStickLevels, "Experto", 0, 0, goldCueStickProperties);
            ...
            CueStick iceCue = new CueStick(cueSprites[1], "Taco de Hielo", "Victoria", "Bangkok", "NA", 0, "0", 0, 0, 4, 5, iceCueStickLevels, "Experto", 0, 0, iceCueStickProperties);
            ...
            CueStick jadeCue = new CueStick(cueSprites[1], "Taco de Jade", "Victoria", "Rome", "NA", 0, "0", 0, 0, 4, 5, jadeCueStickLevels, "Experto", 0, 0, jadeCueStickProperties);
            ...
            CueStick leopardCue = new CueStick(cueSprites[1], "Taco Leopardo", "Victoria", "Seoul", "NA", 0, "0", 0, 0, 4, 5, leopardCueStickLevels, "Experto", 0, 0, leopardCueStickProperties);
            ...
            CueStick lightiningCue = new CueStick(cueSprites[1], "Lightining Cue", "Victory", "Berlin", "NA", 0, "0", 0, 0, 4, 5, lightiningCueStickLevels, "Experto", 0, 0, lightiningCueStickProperties);
            ...
            CueStick platinumCue = new CueStick(cueSprites[1], "Taco de Platino", "Victoria", "Berlin", "NA", 0, "0", 0, 0, 4, 5, platinumCueStickLevels, "Experto", 0, 0, platinumCueStickProperties);
            ...
            CueStick potterCue = new CueStick(cueSprites[1], "Taco Alfarero", "Victoria", "Berlin", "NA", 0, "0", 0, 0, 4, 5, potterCueStickLevels, "Experto", 0, 0, potterCueStickProperties);
            ...
            CueStick shanghaiDragonCue = new CueStick(cueSprites[1], "Taco Shanghai", "Victoria", "Berlin", "NA", 0, "0", 0, 0, 4, 5, shanghaiDragonCueStickLevels, "Experto", 0, 0, shanghaiDragonCueStickProperties);
            ...
            CueStick sharkCue = new CueStick(cueSprites[1], "Taco Salto", "Victoria", "Mumbai", "NA", 0, "0", 0, 0, 4, 5, sharkCueStickLevels, "Experto", 0, 0, sharkCueStickProperties);
            ...
            CueStick solaySystemCue = new CueStick(cueSprites[1], "Taco Sistema Solar", "Victoria", "Mumbai", "NA", 0, "0", 0, 0, 4, 5, solarSystemCueStickLevels, "Experto", 0, 0, solarSystemCueStickProperties);
            ...
            CueStick thebountyHunterCue = new CueStick(cueSprites[1], "Taco Cazarreconpensas", "Victoria", "Bangkok", "NA", 0, "0", 0, 0, 4, 5, thebountyHunterCueStickLevels, "Experto", 0, 0, thebountyHunterCueStickProperties);
            ...
            CueStick titanCue = new CueStick(cueSprites[1], "Taco Titán", "Victoria", "Seoul", "NA", 0, "0", 0, 0, 4, 5, titanCueStickLevels, "Experto", 0, 0, titanCueStickProperties);
            ...
            CueStick tungstenCue = new CueStick(cueSprites[1], "Taco Tustenio", "Victoria", "Bangkok", "NA", 0, "0", 0, 0, 4, 5, tungstenCueStickLevels, "Experto", 0, 0, tungstenCueStickProperties);
            ...
            CueStick winterCue = new CueStick(cueSprites[1], "Taco de Invierno", "Victoria", "Bangkok", "NA", 0, "0", 0, 0, 4, 5, winterCueStickLevels, "Experto", 0, 0, winterCueStickProperties);
            ...
            CueStick amberCue = new CueStick(cueSprites[1], "Taco Ambar", "Victoria", "Cairo", "NA", 0, "0", 0, 0, 4, 5, amberCueStickLevels, "Advanzado", 0, 0, amberCueStickProperties);
            ...
            CueStick amsterdamCue = new CueStick(cueSprites[1], "Taco Amsterdam", "Victoria", "Amsterdam", "NA", 0, "0", 0, 0, 4, 5, amsterdamCueStickLevels, "Advanzado", 0, 0, amsterdamCueStickProperties);
            ...
            CueStick amehystCue = new CueStick(cueSprites[1], "Taco Ameno", "Victoria", "Dubai", "NA", 0, "0", 0, 0, 4, 5, amehystCueStickLevels, "Advanzado", 0, 0, amehystCueStickProperties);
            ...
            CueStick atomCue = new CueStick(cueSprites[1], "Taco Átomo", "Victoria", "Dubai", "NA", 0, "0", 0, 0, 4, 5, atomCueStickLevels, "Advanzado", 0, 0, atomCueStickProperties);
            ...
            CueStick barbaricCue = new CueStick(cueSprites[1], "Taco Bárbaro", "Victoria", "Toronto", "NA", 0, "0", 0, 0, 4, 5, barbaricCueStickLevels, "Advanzado", 0, 0, barbaricCueStickProperties);
            ...
            CueStick barcelonaCue = new CueStick(cueSprites[1], "Taco Barcelona", "Victoria", "Barcelona", "NA", 0, "20", 20, 0, 4, 5, barcelonaCueStickLevels, "Advanzado", 0, 0, barcelonaCueStickProperties);
            ...
            CueStick beechCue = new CueStick(cueSprites[1], "Taco Playa", "Victoria", "Jakarta", "NA", 0, "0", 0, 0, 4, 5, beechCueStickLevels, "Advanzado", 0, 0, beechCueStickProperties);
            ...
            CueStick binderCue = new CueStick(cueSprites[1], "Taco Picha", "Victoria", "Toronto", "NA", 0, "0", 0, 0, 4, 5, binderCueStickLevels, "Advanzado", 0, 0, binderCueStickProperties);
            ...
            CueStick blackmattteCue = new CueStick(cueSprites[1], "Taco Negro Mate", "Victoria", "Dubai", "NA", 0, "0", 0, 0, 4, 5, blackmatteCueStickLevels, "Advanzado", 0, 0, blackmatteCueStickProperties);
            ...
            CueStick blueHopeCue = new CueStick(cueSprites[1], "Tzco Azúl Esperanza", "Victoria", "Jakarta", "NA", 0, "0", 0, 0, 4, 5, blueHopeCueStickLevels, "Advanzado", 0, 0, blueHopeCueStickProperties);
            ...
            CueStick buenosAiresCue = new CueStick(cueSprites[1], "Taco Buenos Aires", "Victoria", "Buenos Aires", "NA", 0, "0", 0, 0, 4, 5, buenosAiresCueStickLevels, "Advanzado", 0, 0, buenosAiresCueStickProperties);
            ...
            CueStick camouflageCue = new CueStick(cueSprites[1], "Taco Camuflaje", "Victoria", "Las Vegas", "NA", 0, "450", 450, 0, 4, 5, camouflageCueStickLevels, "Advanzado", 0, 0, camouflageCueStickProperties);
            ...
            CueStick crystalCue = new CueStick(cueSprites[1], "Taco de Cristal", "Victoria", "Paris", "NA", 0, "0", 0, 0, 4, 5, crystalCueStickLevels, "Advanzado", 0, 0, crystalCueStickProperties);
            ...
            CueStick digitizedCue = new CueStick(cueSprites[1], "Taco Digital", "Victoria", "Las Vegas", "NA", 0, "0", 0, 0, 4, 5, digitizedCueStickLevels, "Advanzado", 0, 0, digitizedCueStickProperties);
            ...
            CueStick ebonyCue = new CueStick(cueSprites[1], "Taco de Ébano", "Victoria", "Paris", "NA", 0, "0", 0, 0, 4, 5, ebonyCueStickLevels, "Advanzado", 0, 0, ebonyCueStickProperties);
            ...
            CueStick flameCue = new CueStick(cueSprites[1], "Taco de Fuego", "Victoria", "Paris", "NA", 0, "0", 0, 0, 4, 5, flameCueStickLevels, "Advanzado", 0, 0, flameCueStickProperties);
            ...
            CueStick insaneCue = new CueStick(cueSprites[1], "Taco Insano", "Victoria", "Paris", "NA", 0, "0", 0, 0, 4, 5, insaneCueStickLevels, "Advanzado", 0, 0, insaneCueStickProperties);
            ...
            CueStick norsemanCue = new CueStick(cueSprites[1], "Taco Nórdico", "Victoria", "Toronto", "NA", 0, "0", 0, 0, 4, 5, norsemanCueStickLevels, "Advanzado", 0, 0, norsemanCueStickProperties);
            ...
            CueStick oakCue = new CueStick(cueSprites[1], "Taco de Roble", "Victoria", "Tokyo", "NA", 0, "300", 300, 0, 4, 5, oakCueStickLevels, "Advanzado", 0, 0, oakCueStickProperties);
            ...
            CueStick palladiumCue = new CueStick(cueSprites[1], "Taco Palacio", "Victoria", "Rome", "NA", 0, "0", 0, 0, 4, 5, palladiumCueStickLevels, "Advanzado", 0, 0, palladiumCueStickProperties);
            ...
            CueStick phantomCue = new CueStick(cueSprites[1], "Taco Phanton", "Victoria", "Jakarta", "NA", 0, "0", 0, 0, 4, 5, phantomCueStickLevels, "Advanzado", 0, 0, phantomCueStickProperties);
            ...
            CueStick platinumViperCue = new CueStick(cueSprites[1], "Taco Platinio", "Victoria", "Jakarta", "NA", 0, "0", 0, 0, 4, 5, platinumViperCueStickLevels, "Advanzado", 0, 0, platinumViperCueStickProperties);
            ...
            CueStick poshCue = new CueStick(cueSprites[1], "Taco Elegante", "Victoria", "Las Vegas", "NA", 0, "0", 0, 0, 4, 5, poshCueStickLevels, "Advanzado", 0, 0, poshCueStickProperties);
            ...
            CueStick rioCue = new CueStick(cueSprites[1], "Taco Rio", "Victoria", "Rio", "NA", 0, "0", 0, 0, 4, 5, rioCueStickLevels, "Advanzado", 0, 0, rioCueStickProperties);
            ...
            CueStick rubyCue = new CueStick(cueSprites[1], "Taco de Rubí", "Victoria", "Shanghai", "NA", 0, "0", 0, 0, 4, 5, rubyCueStickLevels, "Advanzado", 0, 0, rubyCueStickProperties);
            ...
            CueStick sapphireCue = new CueStick(cueSprites[1], "Taco Zafiro", "Victoria", "Cairo", "NA", 0, "0", 0, 0, 4, 5, sapphireCueStickLevels, "Advanzado", 0, 0, sapphireCueStickProperties);
            ...
            CueStick silverCue = new CueStick(cueSprites[1], "Taco de Plata", "Victoria", "Shanghai", "NA", 0, "0", 0, 0, 4, 5, silverCueStickLevels, "Advanzado", 0, 0, silverCueStickProperties);
            ...
            CueStick singaporeCue = new CueStick(cueSprites[1], "Taco Singapur", "Victoria", "Singapore", "NA", 0, "0", 0, 0, 4, 5, singaporeCueStickLevels, "Advanzado", 0, 0, singaporeCueStickProperties);
            ...
            CueStick steampunkCue = new CueStick(cueSprites[1], "Taco Punky", "Victoria", "Toronto", "NA", 0, "0", 0, 0, 4, 5, steampunkCueStickLevels, "Advanzado", 0, 0, steampunkCueStickProperties);
            ...
            CueStick teakCue = new CueStick(cueSprites[1], "Taco Tea", "Victoria", "Dubai", "NA", 0, "0", 0, 0, 4, 5, teakCueStickLevels, "Advanzado", 0, 0, teakCueStickProperties);
            ...
            CueStick testTubeCue = new CueStick(cueSprites[1], "Taco de Tubo", "Victoria", "Las Vegas", "NA", 0, "0", 0, 0, 4, 5, testTubeCueStickLevels, "Advanzado", 0, 0, testTubeCueStickProperties);
            ...
            CueStick theSherifCue = new CueStick(cueSprites[1], "Taco Sheriff", "Victoria", "Dubai", "NA", 0, "0", 0, 0, 4, 5, theSherifCueStickLevels, "Advanzado", 0, 0, theSheriffCueStickProperties);
            ...
            CueStick tigerCue = new CueStick(cueSprites[1], "Taco Tigre", "Victoria", "Cairo", "NA", 0, "0", 0, 0, 4, 5, tigerCueStickLevels, "Advanzado", 0, 0, tigerCueStickProperties);
            ...
            CueStick titaniumCue = new CueStick(cueSprites[1], "Taco de Titanio", "Victoria", "Toronto", "NA", 0, "0", 0, 0, 4, 5, titaniumCueStickLevels, "Advanzado", 0, 0, titaniumCueStickProperties);
            ...
            CueStick walnutCue = new CueStick(cueSprites[1], "Taco Mamut", "Victoria", "Rome", "NA", 0, "0", 0, 0, 4, 5, walnutCueStickLevels, "Advanzado", 0, 0, walnutCueStickProperties);
            ...
            CueStick iCue = new CueStick(cueSprites[1], "Taco I", "Victoria", "Paris", "NA", 0, "0", 0, 0, 4, 5, iCueStickLevels, "Advanzado", 0, 0, iCueStickProperties);
            ...
            CueStick zombieCue = new CueStick(cueSprites[1], "Taco Zombi", "Victoria", "Shanghai", "NA", 0, "0", 0, 0, 4, 5, zombieCueStickLevels, "Advanzado", 0, 0, zombieCueStickProperties);
            ...
            CueStick bearpawCue = new CueStick(cueSprites[1], "Taco Pata de Oso", "Victoria", "Moscow", "NA", 0, "220", 220, 0, 4, 5, bearpawCueStickLevels, "Basico", 0, 0, bearpawCueStickProperties);
            ...
            CueStick bronzeCue = new CueStick(cueSprites[1], "Taco de Bronce", "Victoria", "Sydney", "NA", 0, "0", 0, 0, 4, 5, bronzeCueStickLevels, "Basico", 0, 0, bronzeCueStickProperties);
            ...
            CueStick carbonFiberCue = new CueStick(cueSprites[1], "Taco de Fibra de Carbono", "Victoria", "Tokyo", "NA", 0, "300", 300, 0, 4, 5, carbonFiberCueStickLevels, "Basico", 0, 0, carbonFiberCueStickProperties);
            ...
            CueStick classicCue = new CueStick(cueSprites[1], "Taco Clásico", "Victoria", "Moscow", "NA", 0, "160", 160, 0, 4, 5, classicCueStickLevels, "Basico", 0, 0, classicCueStickProperties);
            ...
            CueStick shamanCue = new CueStick(cueSprites[1], "Taco Shaman", "Victoria", "Tokyo", "NA", 0, "220", 220, 0, 4, 5, shamanCueStickLevels, "Basico", 0, 0, shamanCueStickProperties);
            ...
            CueStick snakeCue = new CueStick(cueSprites[1], "Taco Serpiente", "Victoria", "Las Vegas", "NA", 0, "450", 450, 0, 4, 5, snakeCueStickLevels, "Basico", 0, 0, snakeCueStickProperties);
            ...
            CueStick theDeputyCue = new CueStick(cueSprites[1], "Taco Adjunto", "Victoria", "Tokyo", "NA", 0, "300", 300, 0, 4, 5, theDeputyCueStickLevels, "Basico", 0, 0, theDeputyCueStickProperties);
            ...
            CueStick vintageCue = new CueStick(cueSprites[1], "Taco Vintage", "Victoria", "Moscow", "NA", 0, "50", 50, 0, 4, 5, vintageCueStickLevels, "Basico", 0, 0, vintageCueStickProperties);
            ...
            CueStick zebraCue = new CueStick(cueSprites[1], "Taco Cebra", "Victoria", "Moscow", "NA", 0, "160", 160, 0, 4, 5, zebraCueStickLevels, "Basico", 0, 0, zebraCueStickProperties);
            victoryCueStickList.Add(zebraCue);

            for (int i = 0; i < victoryCueStickList.Count; i++)
            {

                if (GetVictoryCueStickType(i) == "Basico")
                {
                    victoryBasicCueStickList.Add(i);
                }
                else if (GetVictoryCueStickType(i) == "Advanzado")
                {
                    victoryAdvancedCueStickList.Add(i);
                }
                else if (GetVictoryCueStickType(i) == "Experto")
                {
        ...
        public void SurpriseCueDetails()
        {
            ...
            CueStick survivalistCue = new CueStick(cueSprites[2], "Taco Superviviente", "Sorpresa", null, "NA", 0, "100", 100, 0, 4, 5, survivalistCueStickLevels, "Raro", 0, 0, survivalistCueStickProperties);
            ...
            CueStick archangelCue = new CueStick(cueSprites[2], "Taco Arcangel", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, archangelCueStickLevels, "Legendario", 0, 0, archangelCueStickProperties);
            ...
            CueStick archonCue = new CueStick(cueSprites[2], "Taco Halcón", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, archonCueStickLevels, "Legendario", 0, 0, archonCueStickProperties);
            ...
            CueStick atlantisCue = new CueStick(cueSprites[2], "Taco Atlantico", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, atlantisCueStickLevels, "Legendario", 0, 0, atlantisCueStickProperties);
            ...
            CueStick axiomCue = new CueStick(cueSprites[2], "Taco Axón", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, axiomCueStickLevels, "Legendario", 0, 0, axiomCueStickProperties);
            ...
            CueStick crystalBladeCue = new CueStick(cueSprites[2], "Taco Cristal Blade", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, crystalBladeCueStickLevels, "Legendario", 0, 0, crystalBladeCueStickProperties);
            ...
            CueStick excaliburCue = new CueStick(cueSprites[2], "Taco Escalibur", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, excaliburCueStickLevels, "Legendario", 0, 0, excaliburCueStickProperties);
            ...
            CueStick firestormCue = new CueStick(cueSprites[2], "Taco Firestone", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, firestormCueStickLevels, "Legendario", 0, 0, firestormCueStickProperties);
            ...
            CueStick infernoCue = new CueStick(cueSprites[2], "Taco Infierno", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, infernoCueStickLevels, "Legendario", 0, 0, infernoCueStickProperties);
            ...
            CueStick krakenCue = new CueStick(cueSprites[2], "Taco de Kraken", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, krakenCueStickLevels, "Legendario", 0, 0, krakenCueStickProperties);
            ...
            CueStick laserCue = new CueStick(cueSprites[2], "Taco Laser", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, laserCueStickLevels, "Legendario", 0, 0, laserCueStickProperties);
            ...
            CueStick mechatronicCue = new CueStick(cueSprites[2], "Taco Mecatrónico", "Sorpresa", null, "NA", 0, "0", 0, 0, 4, 5, mechatronicCueStickLevels, "Legendario", 0, 0, mechatronicCueStickProperties);
            ...
            CueStick medusaCue = new CueStick(cueSprites[2], "Medusa Cue", "Surprise", null, "NA", 0, "0", 0, 0, 4, 5, medusaCueStickLevels, "Legendario", 0, 0, medusaCueStickProperties);
            ...
            CueStick minotaurCue = new CueStick(cueSprites[2], "Minotaur Cue", "Surprise", null, "NA", 0, "0", 0, 0, 4, 5, minotaurCueStickLevels, "Legendario", 0, 0, minotaurCueStickProperties);
            ...
            CueStick mythicalCue = new CueStick(cueSprites[2], "Mythical Cue", "Surprise", null, "NA", 0, "0", 0, 0, 4, 5, mythicalCueStickLevels, "Legendario", 0, 0, mythicalCueStickProperties);
            ...
            CueStick necromancerCue = new CueStick(cueSprites[2], "Necromancer Cue", "Surprise", null, "NA", 0, "0", 0, 0, 4, 5, necromancerCueStickLevels, "Legendario", 0, 0, necromancerCueStickProperties);
            ...
            CueStick phoenixCue = new CueStick(cueSprites[2], "Phoenix Cue", "Surprise", null, "NA", 0, "0", 0, 0, 4, 5, phoenixCueStickLevels, "Legendario", 0, 0, phoenixCueStickProperties);
            ...
            CueStick plasmaCue = new CueStick(cueSprites[2], " Plasma Cue", "Surprise", null, "NA", 0, "0", 0, 0, 4, 5, plasmaCueStickLevels, "Legendario", 0, 0, plasmaCueStickProperties);
            ...
            CueStick shangriLaCue = new CueStick(cueSprites[2], "Shangri La Cue", "Surprise", null, "NA", 0, "0", 0, 0, 4, 5, shangriLaCueStickLevels, "Legendario", 0, 0, shangriLaCueStickProperties);
            ...
            CueStick thorHammerCue = new CueStick(cueSprites[2], "Thor Hammer Cue", "Surprise", null, "NA", 0, "0", 0, 0, 4, 5, thorHammerCueStickLevels, "Legendario", 0, 0, thorHammerCueStickProperties);
            ...
            CueStick valkyrieCue = new CueStick(cueSprites[2], "Valkyrie Cue", "Surprise", null, "NA", 0, "0", 0, 0, 4, 5, valkyrierCueStickLevels, "Legendario", 0, 0, valkyrieCueStickProperties);
            ...
            for (int i = 0; i < surpriseCueStickList.Count; i++)
            {
                ...
                else if (GetSurpriseCueStickType(i) == "Legendario")
                {
                    surpriseLegendarioCueStickList.Add(i);
                }
