...
namespace RevolutionGames.Data
{
    public class DataManager : MonoBehaviour
    {
        ...
        {
            cityDataManager.SetCityData("Tokyo", new string[] { "Basico", "Avanzado" });
            cityDataManager.SetCityData("Amsterdam", new string[] { "Avanzado" });
            cityDataManager.SetCityData("Bangkok", new string[] { "Experto" });
            cityDataManager.SetCityData("Barcelona", new string[] { "Experto" });
            cityDataManager.SetCityData("Las Vegas", new string[] { "Basico", "Avanzado" });
            cityDataManager.SetCityData("London", new string[] { "Basico" });
            cityDataManager.SetCityData("London", new string[] { "Avanzado" });
        }
        ...
        {
            if (cityDataManager.GetSurpriseBoxCueType(index) == "Basico")
            {
                return cueStickDataManager.GetVictoryBasicCueStickIndex();
            }
            else if (cityDataManager.GetSurpriseBoxCueType(index) == "Avanzado")
            {
                return cueStickDataManager.GetVictoryAdvancedCueStickIndex();
            }
            else if (cityDataManager.GetSurpriseBoxCueType(index) == "Experto")
            {
